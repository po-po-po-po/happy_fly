...
hotCities[8] = new Array('SYX','三亚凤凰','KUNMING','海南');
...
citys[178] = new Array('KJH','凯里黄平','凯里','贵州');
citys[179] = new Array('KCA','库车龟兹','库车','新疆');
citys[180] = new Array('JMJ','澜沧景迈','澜沧','云南');
citys[181] = new Array('HZH','黎平','黎平','贵州');
citys[182] = new Array('LNJ','临沧博尚','临沧','云南');
citys[183] = new Array('LPF','六盘水月照','六盘水','贵州');
citys[184] = new Array('LNL','陇南成县','陇南','甘肃');
citys[185] = new Array('NZH','满洲里西郊','满洲里','内蒙古');
citys[186] = new Array('OHE','漠河古莲','漠河','黑龙江');
citys[187] = new Array('MDG','牡丹江海浪','牡丹江','黑龙江');
citys[188] = new Array('NLH','宁蒗泸沽湖','宁蒗','四川');
citys[189] = new Array('PZI','攀枝花保安营','攀枝花','四川');
citys[190] = new Array('HBQ','海北祁连','祁连','青海');
citys[191] = new Array('NDG','齐齐哈尔三家子','齐齐哈尔','黑龙江');
citys[192] = new Array('IQN','庆阳西峰','庆阳','甘肃');
citys[193] = new Array('BAR','琼海博鳌','琼海','海南');
citys[194] = new Array('JUZ','衢州','衢州','浙江');
citys[195] = new Array('RKZ','日喀则和平','日喀则','西藏');
citys[196] = new Array('QSZ','莎车叶尔羌','莎车','新疆');
citys[197] = new Array('YSQ','松原查干湖','松原','吉林');
citys[198] = new Array('HPG','神农架红坪','神农架','湖北');
citys[199] = new Array('SHF','石河子花园','石河子','新疆');
citys[200] = new Array('HYN','台州路桥机场','台州','浙江');
citys[201] = new Array('TNH','通化三源浦','通化','吉林');
citys[202] = new Array('TLQ','吐鲁番交河','吐鲁番','新疆');
citys[203] = new Array('UCB','乌兰察布集宁','乌兰察布','内蒙古');
citys[204] = new Array('WNH','文山砚山','文山','云南');
citys[205] = new Array('WUA','乌海','乌海','内蒙古');
citys[206] = new Array('WSK','重庆巫山','巫山','重庆');
citys[207] = new Array('XIC','西昌青山','西昌','四川');
citys[208] = new Array('XIL','锡林浩特','锡林浩特','内蒙古');
citys[209] = new Array('LDS','伊春林都','伊春','黑龙江');
citys[210] = new Array('ENY','延安南泥湾','延安','陕西');
citys[211] = new Array('YKH','营口兰旗','营口','辽宁');
citys[212] = new Array('YZY','张掖甘州','张掖','甘肃');
